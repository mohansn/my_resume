...
\familyname {S N}
\photo{me}
\address {Indian Institute of Information Technology and Management-Kerala,}{\quad Technopark Campus, Kariyavattom P.O.,\newline{} Trivandrum, Kerala 695581}
\phone[mobile]{+91~98~67~00~8690}
...
\section{Education}
\cventry {June 2012-June 2014} {M.Sc.$\,$(Computational Science)}{Cochin University of Science and Technology}{}{\textit{Results awaited}}{}
\cventry {October 2012}{Certificate in 'Computing for data analysis'}{Johns Hopkins University, Maryland, USA via coursera.org}{}{}{}
\cventry {2006}{Diploma in embedded systems}{IIT-Bombay}{}{\textit{Grade AA}}{}
...
\section {Internship}
\cvline {Summer research at Centre for Mathematical Modelling and Computer Simulation} {Nonlinear Vibration in Single-walled Carbon Nanotube using Homotopy Analysis Method}

\section {Honours and achievements}
\cvline {} {Certificate of recognition from EMC corporation for outstanding contributions.}
\cvline {TOEFL} {Overall band score of 8.5 (of a maximum of 9)}
...
\cvline {Basic} {Common LISP, GNU Make, ChemCraft, Gaussian 09, OpenMP, Java, Python, GNUPlot, CVS version control software,  Linux system administration}
\cvline {Intermediate} {C, C++, R, MATLAB,Mathematica, gdb (debugger for C/C++), \LaTeX \hspace{1pt} document preparation system (articles and presentation slides), git version control software, Linux systems programming}
\cvline {Miscellaneous} {LibreOffice and Microsoft Office}

\section{Languages}
\cvline {English, Hindi, Marathi} {Read/Write/Speak}
\cvline {Tamil, Kannada} {Speak}
\end {document}
